...
class _KetQuaTuyenState extends State<KetQuaTuyen> {
  ...
  List<Map<String, dynamic>> get _danhSachChuyen {
    ...
    final loai = km <= 15 ? 'Xe 16 chỗ thường' : 'Xe 16 chỗ điều hòa';
    final maTuyen = _layMaTuyen(widget.diemDi, widget.diemDen);
    final List<String> gioKhoiHanh = km <= 12
        ? ['06:00', '06:45', '07:30', '08:30', '10:00', '12:00', '14:00', '16:00', '17:30']
        : km <= 25
            ? ['06:00', '07:15', '08:30', '10:30', '12:30', '14:30', '16:30']
            : ['06:30', '08:00', '10:00', '12:00', '14:30', '16:30'];
    const gheSoLuong = [12, 3, 14, 8, 10, 5, 13, 6, 15];
