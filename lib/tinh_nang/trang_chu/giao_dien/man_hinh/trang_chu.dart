...
import '../../../tim_tuyen_xe/dich_vu/tim_tuyen_giong_noi_service.dart';
import '../../../tim_tuyen_xe/giao_dien/man_hinh/tim_tuyen_xe.dart';
import '../../../tai_khoan/giao_dien/man_hinh/ve_cua_toi.dart';
import '../../../tai_khoan/giao_dien/man_hinh/tai_khoan.dart';
...
class _TrangChuState extends State<TrangChu> {
  // Controller dùng chung để điều hướng giữa các tab từ nhiều màn hình con.
  ...
  Widget build(BuildContext context) {
    return CupertinoTabScaffold(
      ...
      tabBuilder: (ctx, idx) {
        // Mỗi tab có một navigation stack riêng để giữ trạng thái khi chuyển tab.
        switch (idx) {
          case 0:
...
class _ManHinhTrangChuState extends State<ManHinhTrangChu>
  ...
  final Set<String> _daNhacVeId = {};
    final TimTuyenGiongNoiDieuPhoi _giongNoiDieuPhoi =
      TimTuyenGiongNoiDieuPhoi();
  ...
  void _onStateChange() {
    // Đồng bộ UI khi trạng thái đăng nhập/danh sách vé thay đổi.
    if (mounted) setState(() {});
    _kiemTraNhacNho();
  }
            ...
            child: FadeTransition(
              ...
              child: Column(
                children: [
                  ...
                  NutGiongNoiTron(
                    dangNghe: _giongNoiDieuPhoi.dangNgheGiongNoi,
                    vanBanDaNghe: _giongNoiDieuPhoi.banGhiGiongNoi,
                    onNhanMic: () {
                      _giongNoiDieuPhoi.batTatNghe(
                        context: context,
                        onCapNhat: () {
                          if (mounted) setState(() {});
                        },
