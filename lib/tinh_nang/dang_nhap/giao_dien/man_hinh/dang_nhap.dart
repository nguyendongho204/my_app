...
import '../../../trang_chu/giao_dien/man_hinh/trang_chu.dart';
...
class _DangNhapState extends State<DangNhap>
  ...
  void _doiTab(int tab) {
    if (_tab == tab) return;
    // Chuyển tab có hiệu ứng mờ để tránh thay đổi nội dung đột ngột.
...
class _FormDangNhapState extends State<_FormDangNhap> {
  ...
  Future<void> _dangNhap() async {
    ...
    // Cập nhật trạng thái phiên đăng nhập toàn cục trước khi điều hướng.
  ...
  void _quenMatKhau() {
    // Luồng 2 bước: xác minh SĐT/email trước, sau đó mới cho đặt mật khẩu mới.
