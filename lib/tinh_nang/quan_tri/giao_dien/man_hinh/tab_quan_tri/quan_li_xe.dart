...
class _QuanLiXeState extends State<QuanLiXe> {
  ...
  Future<void> _tai() async {
    ...
    try {
      // Tải danh sách xe hiện có để phục vụ thao tác sửa/thêm nhanh tại chỗ.
                ...
                SizedBox(
                  ...
                  child: CupertinoButton.filled(
                    onPressed: () async {
                      ...
                      // Đóng modal trước khi gọi cập nhật để tránh thao tác trùng khi chờ.
                      Navigator.of(context, rootNavigator: true).pop();
                      await CoSoDuLieu().capNhatXe(x.id!, {
                        'bienSo': bs, 'loaiXe': loaiXeMacDinh, 'soGhe': 16,
                      });
                      _tai();
                    },
                ...
                SizedBox(
                  ...
                  child: CupertinoButton.filled(
                    onPressed: () async {
                      ...
                      // Tạo xe mới với thông số mặc định 16 chỗ theo chuẩn ứng dụng.
                      Navigator.of(context, rootNavigator: true).pop();
