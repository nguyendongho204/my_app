...
class _QuanLiTuyenState extends State<QuanLiTuyen> {
  ...
  Future<void> _tai() async {
    ...
    try {
      // Tải song song dữ liệu tuyến, lịch chạy, xe và tài xế để đồng bộ màn hình.
    ...
    showCupertinoModalPopup(
      ...
      builder: (_) => StatefulBuilder(
        builder: (ctx, setM) => _Modal(
          ...
          loi: loi,
          onLuu: () async {
            // Validate cơ bản trước khi tạo tuyến mới trong cơ sở dữ liệu.
  ...
  void _suaLich(LichChay l) {
    ...
    // Picker dùng item 0 cho "Không phân công", nên index dữ liệu thực phải +1.
                      ...
                      children: [
                        Text('${l.diemDi} → ${l.diemDen}',
                            style: const TextStyle(
                                ...
                                fontSize: 14)),
                        Text(
                          '${l.soGheConLai}/${l.soGheToiDa} ghế trống',
                          style: const TextStyle(
