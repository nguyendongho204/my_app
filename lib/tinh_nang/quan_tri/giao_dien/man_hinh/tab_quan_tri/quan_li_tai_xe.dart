...
class _QuanLiTaiXeState extends State<QuanLiTaiXe> {
  ...
  Future<void> _tai() async {
    ...
    try {
      // Đồng bộ danh sách tài xế từ DB trước khi render danh sách và biểu mẫu.
                ...
                SizedBox(
                  ...
                  child: CupertinoButton.filled(
                    onPressed: () async {
                      ...
                      // Lưu cập nhật hồ sơ tài xế hiện tại.
                ...
                SizedBox(
                  ...
                  child: CupertinoButton.filled(
                    onPressed: () async {
                      ...
                      // Tạo hồ sơ tài xế mới ở trạng thái sẵn sàng phân công.
                      Navigator.of(context, rootNavigator: true).pop();
