...
import '../../../thanh_toan/giao_dien/man_hinh/thanh_toan.dart';
...
class _ChonGheState extends State<ChonGhe> {
  // Danh sách ghế đã đặt (không thể chọn lại) và ghế người dùng đang chọn.
  ...
  void initState() {
    super.initState();
    // Mô phỏng ghế đã đặt dựa trên số ghế còn trống từ chuyến đã chọn.
  ...
  // Bấm ghế: bỏ chọn nếu đã chọn, thêm mới nếu chưa vượt quá số ghế tối đa.
  void _bamGhe(int so) {
  ...
  // Tổng tiền = đơn giá mỗi ghế * số ghế đang chọn.
  int get _tongTien {
              ...
              if (_gheDangChon.isNotEmpty)
                Padding(
                  ...
                  child: NutGradient(
                    ...
                    onNhan: () async {
                      // Bắt buộc đăng nhập trước khi chuyển sang thanh toán.
                      ...
                      // Sang màn thanh toán và truyền đầy đủ dữ liệu ghế/chuyến.
                      Navigator.push(
                        context,
                        CupertinoPageRoute(
                          builder: (_) => ThanhToan(
